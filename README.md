...
Circom aims to provide developers with a holistic framework for constructing arithmetic circuits, using an easy-to-use interface and abstracting the complexity of the proving mechanisms.
...
Basic background on Zero-knowledge proofs can be found in [Background section](https://docs.circom.io/background/background/).
